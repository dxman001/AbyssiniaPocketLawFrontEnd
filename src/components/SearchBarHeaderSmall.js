...
export default function SearchBarHeaderSmall({searchkeyDynamic,setSearchKeyDynamic,searchTypeDynamic,setSearchTypeDynamic,setSearchResult,setSearchResultCount,pageIndex,setPageIndex})
{
